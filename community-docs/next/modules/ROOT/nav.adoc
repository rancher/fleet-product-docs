...
**** xref:reference/cli/fleet-cli/analyze.adoc[fleet analyze]
**** xref:reference/cli/fleet-cli/monitor.adoc[fleet monitor]
**** xref:reference/cli/fleet-cli/dump.adoc[fleet dump]

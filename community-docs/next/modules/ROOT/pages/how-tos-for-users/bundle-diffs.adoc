...
If an administrator manually edits a {product_name}-managed resource using kubectl edit, {product_name} marks the bundle as ++Modified++.
...
* {product_name} ignores temporary jobs created and deleted by the application lifecycle

...
* Fleet can now handle a separate webhook secret for each GitRepo xref:how-tos-for-users/webhook.adoc#option-2-configure-secret[Define a secret for each GitRepo], by https://github.com/0xavi0[@0xavi0] in https://github.com/rancher/fleet/pull/3490

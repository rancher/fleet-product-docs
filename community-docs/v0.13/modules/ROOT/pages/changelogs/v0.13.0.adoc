...
* Fleet now supports a new, user-driven bundle scan method, for more flexibility. The usual scanning method is still supported xref:how-tos-for-users/gitrepo-content.adoc#_alternative_scan_explicitly_defined_by_the_user[Alterate scan]), by https://github.com/0xavi0[@0xavi0] in https://github.com/rancher/fleet/pull/3480

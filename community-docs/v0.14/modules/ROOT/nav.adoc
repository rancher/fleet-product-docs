...
**** xref:reference/cli/fleet-cli/fleet_cleanup_clusterregistration.adoc[fleet cluster registration cleanup]
**** xref:reference/cli/fleet-cli/fleet_cleanup_gitjob.adoc[fleet gitjob cleanup]
*** Fleet Controller 

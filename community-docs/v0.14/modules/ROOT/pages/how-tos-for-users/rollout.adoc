...
1. {product_name} checks the readiness of clusters in the partition.
...
1. When the entire partition is mostly ready (90%), {product_name} moves to the next partition.

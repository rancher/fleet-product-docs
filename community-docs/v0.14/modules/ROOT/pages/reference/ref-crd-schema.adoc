...
| xref:./crds/bundle_v1alpha1.json[Bundle v1alpha1]
...
| `apiVersion, kind, metadata, spec, status`
| xref:./crds/bundledeployment_v1alpha1.json[BundleDeployment v1alpha1]
...
| xref:./crds/bundlenamespacemapping_v1alpha1.json[BundleNamespaceMapping v1alpha1]
...
| xref:./crds/content_v1alpha1.json[Content v1alpha1]
...
| `apiVersion, kind, metadata, spec, status`
| xref:./crds/gitreporestriction_v1alpha1.json[GitRepo v1alpha1]

...
[#_creating_the_productname_agent_deployment]
...
[#_productname_agent_starts_registration_upgrades_to_request_account]
...
[#_productname_agent_is_registered_watches_for_bundledeployments]
...
image::registration_flow.svg[Registration Flow]
...
[#_productname_cluster_registration_in_rancher]

...
Some resources, such as generated Job objects, can have dynamically generated names. Instead of creating a separate diff rule for each resource, use regular expressions in the name field.

For example, you need to ignores all Job resources in the fleet-demo namespace whose names start with demo.

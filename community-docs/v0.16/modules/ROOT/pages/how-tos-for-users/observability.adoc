...
* `FailedToApplyRestrictions`- the GitRepo resource violates the rules of a `Policy` (or, where still in use, a `GitRepoRestriction`) in its namespace

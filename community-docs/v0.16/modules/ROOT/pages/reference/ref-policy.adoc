...
# When true, Helm may create the target namespace on downstream clusters.
...
| —
| —
| applies (disables Helm namespace creation when `requireServiceAccount` is true and this field is false)

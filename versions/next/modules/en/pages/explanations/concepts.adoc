...
For more information, refer to xref:troubleshooting.adoc#_naming_conventions_for_crds[naming conventions of CRD].
====
 ...
 ** To see the *life cycle of a bundle*, refer to xref:explanations/ref-bundle-stages.adoc[bundle stages].
 ...
 ** For an example of how to deploy Kubernetes manifests across clusters using {product_name} customization, refer to xref:how-tos-for-users/gitrepo-targets.adoc#_customization_per_cluster[customizing per cluster].

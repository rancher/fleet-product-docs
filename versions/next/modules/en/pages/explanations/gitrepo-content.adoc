...
The targeting step can treat the values as a template and fill in information from the `clusters.fleet.cattle.io` resource. More information can be found in xref:reference/ref-fleet-yaml.adoc#_values Templating[Helm values templating].

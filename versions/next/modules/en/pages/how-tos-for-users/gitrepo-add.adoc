...
[NOTE]
====
{product_name} does not support SSH proxy server authentication when cloning <<_adding-a-private-git-repository,adding-a-private-git-repository>>or <<_using-private-helm-repositories,Using Private Helm Repositories>>

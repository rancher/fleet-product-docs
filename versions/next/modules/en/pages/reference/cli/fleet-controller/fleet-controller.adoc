...
* xref:/reference/cli/fleet-controller/cli\fleet-controller\fleet-controller_gitjob.adoc[fleet-controller gitjob]	 - Configure Fleet controller gitjob operations

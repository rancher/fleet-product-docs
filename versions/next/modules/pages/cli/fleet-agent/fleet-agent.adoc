...
* link:fleet-agent/fleet-agent_clusterstatus[fleet-agent clusterstatus]	 - Continuously report resource status to the upstream cluster
* link:fleet-agent/fleet-agent_register[fleet-agent register]	 - Register agent with an upstream cluster

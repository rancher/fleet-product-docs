...
<<_suse_rancher_prime_continous_delivery,{product_name}>> uses Kubernetes RBAC where possible.

endif::[]

ifeval::["{build-type}" == "community"]
<<_continous_delivery,{product_name}>> uses Kubernetes RBAC where possible.
...
ifeval::["{build-type}" == "product"]
Even with the available <<_suse_rancher_prime_continous_delivery,{product_name}>> restrictions, users are only restricted to namespaces, but namespaces don't provide much isolation on their own. E.g. they can still consume as many resources as they like.

However, the existing <<_suse_rancher_prime_continous_delivery,{product_name}>> restrictions allow users to share clusters, anddeploy resources without conflicts.
endif::[]

ifeval::["{build-type}" == "community"]
Even with the available <<_continous_delivery,{product_name}>> restrictions, users are only restricted to namespaces, but namespaces don't provide much isolation on their own. E.g. they can still consume as many resources as they like.

However, the existing <<_continous_delivery,{product_name}>> restrictions allow users to share clusters, anddeploy resources without conflicts.
endif::[] 

====

ifeval::["{build-type}" == "product"]
== Example <<_suse_rancher_prime_continous_delivery,{product_name}>> Standalone

endif::[]

ifeval::["{build-type}" == "community"]
== Example <<_continous_delivery,{product_name}>> Standalone

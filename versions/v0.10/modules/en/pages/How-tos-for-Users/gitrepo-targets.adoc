...
https://rancher.com/docs/rancher/v2.6/en/deploy-across-clusters/fleet/[{product_name} in Rancher] allows users to manage clusters easily as if they were one cluster. Users can deploy bundles, which can be comprised of deployment manifests or any other Kubernetes resource, across clusters using grouping configuration.
...
* xref:Reference/ref-crds#_bundledeploymentoptions[DefaultNamespace]
* xref:Reference/ref-crds#_bundledeploymentoptions[ForceSyncGeneration]
* xref:Reference/ref-crds#_bundledeploymentoptions[KeepResources]
* xref:Reference/ref-crds#_bundledeploymentoptions[ServiceAccount]
* xref:Reference/ref-crds#_bundledeploymentoptions[TargetNamespace]
* xref:Reference/ref-crds#_helmoptions[Helm.Atomic]
* xref:Reference/ref-crds#_helmoptions[Helm.Chart]
* xref:Reference/ref-crds#_helmoptions[Helm.DisablePreProcess]
* xref:Reference/ref-crds#_helmoptions[Helm.Force]
* xref:Reference/ref-crds#_helmoptions[Helm.ReleaseName]
* xref:Reference/ref-crds#_helmoptions[Helm.Repo]
* xref:Reference/ref-crds#_helmoptions[Helm.TakeOwnership]
* xref:Reference/ref-crds#_helmoptions[Helm.TimeoutSeconds]
* xref:Reference/ref-crds#_helmoptions[Helm.ValuesFrom]
* xref:Reference/ref-crds#_helmoptions[Helm.Values]
* xref:Reference/ref-crds#_helmoptions[Helm.Version]
+
...
* xref:Reference/ref-crds#_helmoptions[Helm.WaitForJobs]
* xref:Reference/ref-crds#_kustomizeoptions[Kustomize.Dir]
* xref:Reference/ref-crds#_yamloptions[YAML.Overlays]
* xref:Reference/ref-crds#_diffoptions[Diff.ComparePatches]

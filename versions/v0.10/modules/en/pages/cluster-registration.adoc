...
[IMPORTANT]
====
If you are using Fleet standalone _without Rancher_, it must be installed as described in xref:./installation#_configuration_for_multi_cluster[installation details].

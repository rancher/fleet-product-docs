...
For more information, refer to xref:troubleshooting.adoc#_naming-conventions-for-crds[naming conventions of CRDs].
====
 ...
 ** To see the *life cycle of a bundle*, refer to xref:explanations/ref-bundle-stages.adoc[bundle lifecycle].
 ...
 ** For an example of how to deploy Kubernetes manifests across clusters using {product_name} customization, click xref:how-tos-for-users/gitrepo-targets.adoc#_customization-per-cluster[customization per cluster].

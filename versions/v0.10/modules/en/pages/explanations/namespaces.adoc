...
[#_fleet_local_local_workspace_cluster_registration_namespace]
...
[#_cattle_fleet_system_system_namespace]
...
[#_cattle_fleet_clusters_system_system_registration_namespace]

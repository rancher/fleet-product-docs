...
[IMPORTANT]
====
If you are using {product_name} standalone _without Rancher_, it must be installed as described in xref:how-tos-for-operators/installation.adoc#_configuration_for_multi_cluster[multi cluster details].

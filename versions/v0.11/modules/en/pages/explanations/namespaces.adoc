...
will always be *fleet-local*. Refer to the <<#_fleet_local_local_workspace_cluster_registration_namespace,`fleet-local` namespaces section>> for more information.

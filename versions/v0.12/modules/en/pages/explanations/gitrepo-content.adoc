...
[#_excluding-files-and-directories]
...
For private Helm repositories, see xref:how-tos-for-users/gitrepo-add.adoc#_using-private-helm-repositories[Using Private Helm Repositories].
...
See xref:how-tos-for-users/gitrepo-targets.adoc#_customization-per-cluster[Customization per Cluster] for details.

[#_raw-yaml-customization]

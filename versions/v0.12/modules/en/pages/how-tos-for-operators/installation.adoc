...
{product_name} is distributed as a Helm chart. Helm 3 is a client-only CLI with no server-side component.  
...
[#_add_the_fleet_helm_repository]
...
[#_install_the_fleet_customresourcedefinitions]
...
[#_install_the_fleet_controllers]
...
[#_tweaking_your_fleet_installation]

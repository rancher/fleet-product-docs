...
xref:./cli/fleet-cli/fleet_apply.adoc[Apply] renders a folder with Kubernetes resources, such as a Helm chart, manifests, or kustomize folders, into a {product_name} bundle resource.
...
For information about apply, refer to xref:bundle-add.adoc[Create a Bundle Resource].

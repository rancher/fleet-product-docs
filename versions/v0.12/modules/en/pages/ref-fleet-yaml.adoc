...
Values are processed in different stages of the xref:ref-bundle-stages.adoc[Bundle lifecycle]
...
You can xref:./ref-bundle-stages.adoc#_fleet_target[test values templating with the CLI] against existing clusters.

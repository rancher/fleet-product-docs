...
* Fleet supports a new, user-driven bundle scan method for greater flexibility. The previous scan method remains supported. See xref:../explanations/gitrepo-content.adoc#_alternative_scan_explicitly_defined_by_the_user[documentation].  

...
* When using SSH to point to a git repository, Fleet checks host keys by default, rejecting connection attempts to unknown hosts xref:how-tos-for-users/gitrepo-add.adoc#_known-hosts[Add GitRepo], by https://github.com/weyfonk[@weyfonk] in https://github.com/rancher/fleet/pull/3523
...
* Fleet now supports a new, user-driven bundle scan method, for more flexibility. The usual scanning method is still supported xref:explanations/gitrepo-content.adoc#_alternative-scan-explicitly-defined-by-the-user[Alterate scan], by https://github.com/0xavi0[@0xavi0] in https://github.com/rancher/fleet/pull/3480
* Replica counts are now configurable, for controllers as well as agents xref:how-tos-for-operators/installation.adoc#_controller-and-agent-replicas[Controller and agent replicas], by https://github.com/p-se[@p-se] in https://github.com/rancher/fleet/pull/3457
* Fleet can now handle a separate webhook secret for each GitRepo xref:how-tos-for-users/webhook.adoc#_option-2-configure-a-secret-per-gitrepo[Define a secret for each GitRepo], by https://github.com/0xavi0[@0xavi0] in https://github.com/rancher/fleet/pull/3490

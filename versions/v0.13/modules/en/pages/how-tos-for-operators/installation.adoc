...
You can now xref:./cluster-registration.adoc[register clusters] and xref:../how-tos-for-users/gitrepo-add.adoc#_create-gitrepo-instance[add Git repositories].

...
[NOTE]
====
If you want to deploy resources without running a Fleet controller. Refer to xref:../explanations/ref-bundle-stages.adoc#examining_the_bundle_lifecycle_with_the_cli[Fleet CLI bundle lifecycle].

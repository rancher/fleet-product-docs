...
[NOTE]
====
If you want to deploy resources without running a Fleet controller. Refer to xref:how-tos-for-users/install-use-fleet-cli.adoc#convert-a-helm-chart-into-a-bundle[Convert a Helm chart into a bundle using CLI.]

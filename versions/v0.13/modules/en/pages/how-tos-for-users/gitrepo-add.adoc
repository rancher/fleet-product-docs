...
[NOTE]
====
Fleet does not support SSH proxy server authentication when cloning <<adding_a_private_git_repository,adding-a-private-git-repository>>or <<_using_private_helm_repositories,Using Private Helm Repositories>>

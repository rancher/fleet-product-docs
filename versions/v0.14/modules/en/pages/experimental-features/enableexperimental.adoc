...
For more information, refer to Configure xref:reference/ref-configuration.adoc#_configure_productname_install_options_in_rancher[{product_name} install options in Rancher]

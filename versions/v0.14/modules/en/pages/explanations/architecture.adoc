...
the xref:how-tos-for-operators/cluster-registration.adoc#_manager-initiated[manager-initiated registration]. cluster registration flow. This is not required, but
an optional pattern.

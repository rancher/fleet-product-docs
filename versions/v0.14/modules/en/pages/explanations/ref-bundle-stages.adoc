...
:page-aliases: /ref-bundle-stages
...
. User will create a xref:how-tos-for-users/gitrepo-add.adoc#_create-gitrepo-instance[GitRepo] that points to the multi-cluster/helm repository.

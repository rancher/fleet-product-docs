...
[NOTE]
====
If you want to deploy resources without running a Fleet controller. Refer to xref:how-tos-for-users/install-use-fleet-cli.adoc#_convert-a-helm-chart-into-a-bundle[Convert a Helm chart into a bundle using CLI.]
====
...
Additional xref:reference/ref-fleet-yaml.adoc#_supported-customizations[customization options] can be specified per target:

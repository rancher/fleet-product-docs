...
[#_alternative-scan-ausdr-cklich-vom-benutzer-definiert]
...
[#_entsprechende-gitrepo-definition]
...
[#_ausschluss-von-dateien-und-verzeichnissen-aus-bundles]
...
Siehe xref:how-tos-for-users/gitrepo-add.adoc#_using-private-helm-repositories[Verwendung privater Helm-Repositorys].

[#_verwendung-von-helm-werten]
...
Der Zielschritt kann Werte als Vorlagen unter Verwendung von Clusterinformationen behandeln. Weitere Informationen: xref:/reference/ref-fleet-yaml.adoc#_values-templating[Vorlagen in fleet.yaml].
...
[#_vorlagenverarbeitung]
=== Vorlagenverarbeitung

Der Zielschritt kann die Werte als Vorlage behandeln und Informationen aus der `clusters.fleet.cattle.io`-Ressource übernehmen. Für weitere Informationen siehe xref:reference/ref-fleet-yaml.adoc#_values-templating[Helm-Wertvorlagen].
...
[#_verst-ndnis-von-helm-values-yaml-vs-fleet-valuesfiles]
...
[#_fleet-werte-dateien-die-aus-fleet-yaml-referenziert-werden]
...
----
Siehe xref:how-tos-for-users/gitrepo-targets.adoc#_customization-per-cluster[Anpassung pro Cluster].

[#_roh-yaml-ressourcenanpassung]

...
Härtete Cluster sollten die Fleet-CRDs zur xref:how-tos-for-users/gitrepo-add.adoc#_storing-credentials-in-git[Liste der im Ruhezustand verschlüsselten Ressourcen] im Upstream-Cluster hinzufügen, wenn Anmeldeinformationen in den Bundles gespeichert werden.

...
Eine Ergänzung zu RBAC ist die xref:explanations/namespaces.adoc#_restricting-gitrepos[`GitRepoRestriction`] Ressource, die verwendet werden kann, um GitRepo-Ressourcen in einem Namespace zu steuern.
...
[#_beispiel-product-name-standalone]
...
[#_isolierte-arbeitsbereiche-in-rancher]
...
Erstellen Sie in jedem Namespace des Benutzers als Administrator ein xref:explanations/namespaces.adoc#_cross-namespace-deployments[`BundleNamespaceMapping`].
...
[#_zugriff-auf-downstream-cluster-einschr-nken]
...
[#_ein-beispiel-f-r-eine-gitrepo-ressource]

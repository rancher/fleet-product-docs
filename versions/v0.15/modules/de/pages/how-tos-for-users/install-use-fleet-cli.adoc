...
** `fleet apply -o - name ./folder`, um die YAML des Bundles vor der Erstellung zu überprüfen. Für weitere Informationen siehe xref:explanations/ref-bundle-stages.adoc#_examining-the-bundle-lifecycle-with-the-cli[Untersuchung des Bundle-Lebenszyklus mit der CLI].
...
Für weitere Informationen siehe xref:reference/ref-registration.adoc#_product-name-agent-is-registered-watches-for-bundledeployments[Fleet-Agent ist registriert, überwacht BundleDeployments].

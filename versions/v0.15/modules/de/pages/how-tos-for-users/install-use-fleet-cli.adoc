...
** `fleet apply -o - name ./folder`, um die YAML des Bundles vor der Erstellung zu überprüfen. Für weitere Informationen siehe xref:explanations/ref-bundle-stages.adoc#_examining_the_bundle_lifecycle_with_the_cli[Untersuchung des Bundle-Lebenszyklus mit der CLI].
...
Für weitere Informationen siehe xref:reference/ref-registration.adoc#_product_name_agent_is_registered_watches_for_bundledeployments[Fleet-Agent ist registriert, überwacht BundleDeployments].

= Fleet cleanup Clusterregistrierung
:revdate: 2025-07-23
:page-revdate: {revdate}

Veraltete Clusterregistrierungen bereinigen
...
* xref:reference/cli/fleet-cli/cleanup/fleet_cleanup.adoc[Fleet cleanup]     - Veraltete Ressourcen bereinigen

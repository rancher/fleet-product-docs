...
Stellen Sie eine Bundle-Deployment-/Inhaltsressource in einem Cluster bereit, indem Sie ein Helm-Release erstellen. Dies wird die Bundle-Deployment-/Inhaltsressourcen nicht direkt im Cluster bereitstellen.
...
* xref:/reference/cli/fleet-cli/fleet.adoc[Fleet]     - Verwalten Sie {product_name} Operationen

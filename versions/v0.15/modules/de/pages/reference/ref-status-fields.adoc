...
* `state` : Stellt den Zustand des GitRepo dar (zum Beispiel `GitUpdating`) oder den höchsten BundleState gemäß dem <<_state-ranking,Statusranking>>. Wenn `Ready`, wird er auf einen leeren Wert gesetzt.

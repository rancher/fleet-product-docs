...
Sie können eine ConfigMap `rancher-config` im `cattle-system` Namespace mit xref:reference/ref-configuration.adoc#_configure_product_install_options_in_rancher[Fleet Installationsoptionen] erstellen.

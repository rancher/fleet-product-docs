...
Sie können eine ConfigMap `rancher-config` im `cattle-system` Namespace mit xref:reference/ref-configuration.adoc#_configure-product-install-options-in-rancher[Fleet Installationsoptionen] erstellen.

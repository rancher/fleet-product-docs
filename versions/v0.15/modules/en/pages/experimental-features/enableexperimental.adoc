...
For more information, refer to Configure xref:reference/ref-configuration.adoc#_configure-product-install-options-in-rancher[{product_name} install options in Rancher]

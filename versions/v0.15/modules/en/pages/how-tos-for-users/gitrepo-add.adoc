...
[NOTE]
====
{product_name} does not support SSH proxy server authentication when cloning xref:#_adding_a_private_git_repository[adding a private gitrepository]or xref:#_using_private_helm_repositories[using Private Helm Repositories]

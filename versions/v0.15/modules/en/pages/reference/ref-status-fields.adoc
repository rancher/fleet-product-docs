...
:page-aliases: /ref-status-fields
...
* `state` : Represents the GitRepo’s state (for example, `GitUpdating`) or the highest BundleState per the <<_state_ranking,State Ranking>>. If `Ready`, it’s set to an empty value.

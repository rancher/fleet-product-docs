...
You can create a config map `rancher-config` in the `cattle-system` namespace with xref:reference/ref-configuration.adoc#_configure-product-install-options-in-rancher[Fleet Installation Options].

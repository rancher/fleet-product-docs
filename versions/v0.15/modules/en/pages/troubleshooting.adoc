...
You can create a config map `rancher-config` in the `cattle-system` namespace with xref:reference/ref-configuration.adoc#_configure_product_install_options_in_rancher[Fleet Installation Options].

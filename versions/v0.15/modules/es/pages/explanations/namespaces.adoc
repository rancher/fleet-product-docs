...
[#_espacios-de-nombres-de-carga-de-trabajo]
== Espacios de nombres de carga de trabajo

[#_comportamiento-de-creaci-n-de-espacio-de-nombres-en-paquetes]
...
[#_configuraci-n-de-espacios-de-nombres-de-carga-de-trabajo]
...
[#_despliegues-entre-espacios-de-nombres]
...
[#_espacios-de-nombres-de-destino-permitidos]
...
[#_selector-de-espacio-de-nombres-de-destino-permitido]
...
[#_product-name-espacios-de-nombres]
...
Si estás utilizando {product_name} en un estilo de xref:explanations/concepts.adoc[clúster único], el espacio de nombres siempre será *fleet-local*.  Consulta la sección <<_cluster-registration-namespace-fleet-local,`fleet-local` espacios de nombres>> para más información.
...
[#_espacios-de-nombres-internos]
=== Espacios de nombres internos

[#_espacio-de-nombres-de-registro-del-cl-ster-fleet-local]
...
[#_espacio-de-nombres-del-sistema-cattle-fleet-system]
...
[#_espacio-de-nombres-de-registro-del-sistema-cattle-fleet-clusters-system]
...
[#_espacios-de-nombres-de-cl-steres]

...
[#_manager-initiated-registration]
...
[#_cluster-registration-token-and-client-id]
...
[#_install-agent-for-a-new-cluster]
...
[#_install-agent-for-a-predefined-cluster]
...
[#_create-cluster-registration-tokens]
...
[#_obtaining-token-value-agent-values-yaml]

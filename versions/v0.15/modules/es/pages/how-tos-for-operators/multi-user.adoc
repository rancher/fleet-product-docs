...
Una adición sobre RBAC es el recurso xref:explanations/namespaces.adoc#_restricting-gitrepos[`GitRepoRestriction`], que se puede utilizar para controlar los recursos de GitRepo en un espacio de nombres.
...
[#_ejemplo-product-name-aut-nomo]
...
[#_espacios-de-trabajo-aislados-en-rancher]
...
En cada uno de los espacios de nombres del usuario, como administrador crea un xref:explanations/namespaces.adoc#_cross-namespace-deployments[`BundleNamespaceMapping`].
...
[#_restringir-el-acceso-a-cl-steres-de-sentido-descendente]
...
[#_un-recurso-gitrepo-de-ejemplo]

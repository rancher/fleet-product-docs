...
[#_ignorar-condiciones-en-fleet-yaml]
== Ignorar condiciones en `fleet.yaml`
...
[#_configurar-asignaci-n-de-errores-con-variables-de-entorno]
...
[#_ejemplo-de-desactivar-la-interpretaci-n-de-errores]
...
[#_ejemplo-de-interpretaci-n-de-errores]
...
[#_asignaciones-de-error-predeterminadas]

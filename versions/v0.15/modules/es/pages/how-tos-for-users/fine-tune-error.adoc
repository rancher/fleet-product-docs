...
NOTA:  +
Sobrescribir condiciones solo afecta los mapeos de error por defecto (consulta xref:#_default-error-mappings[Mapeos de error por defecto]). {product_name} aún puede marcar un recurso como un error porque otras comprobaciones, como las de la biblioteca `kstatus`, continúan ejecutándose después de tu personalización.

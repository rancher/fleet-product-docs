...
[#_referencia-de-gr-fico-y-url-del-repositorio]
...
[#_usando-repositorios-privados-de-helm]
...
Para más información, consulta xref:how-tos-for-users/gitrepo-add.adoc#_using-private-helm-repositories[Repositorio privado de Helm].

...
** `fleet apply -o - name ./folder` para comprobar el YAML del paquete antes de crearlo. Para más información, consulta xref:explanations/ref-bundle-stages.adoc#_examining_the_bundle_lifecycle_with_the_cli[Examinando el Ciclo de Vida del Paquete con la CLI].
...
Para más información, consulta xref:reference/ref-registration.adoc#_product_name_agent_is_registered_watches_for_bundledeployments[El Agente de Fleet está registrado, observa las ampliaciones de paquetes].

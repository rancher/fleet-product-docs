...
[#_verifica-los-requisitos-previos]
...
[#_desplegar-un-paquete-de-muestra-usando-fleet-cli]
...
[#_convierte-un-helm-chart-en-un-paquete]
...
[#_verifica-el-estado-del-agente-y-del-controlador]

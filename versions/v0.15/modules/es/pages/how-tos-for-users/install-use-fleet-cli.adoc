...
** `fleet apply -o - name ./folder` para comprobar el YAML del paquete antes de crearlo. Para más información, consulta xref:explanations/ref-bundle-stages.adoc#_examining-the-bundle-lifecycle-with-the-cli[Examinando el Ciclo de Vida del Paquete con la CLI].
...
Para más información, consulta xref:reference/ref-registration.adoc#_product-name-agent-is-registered-watches-for-bundledeployments[El Agente de Fleet está registrado, observa las ampliaciones de paquetes].

...
* `state` : Representa el estado del GitRepo (por ejemplo, `GitUpdating`) o el estado de paquete más alto según el <<_state-ranking,Rango de Estado>>. Si `Ready`, se establece en un valor vacío.

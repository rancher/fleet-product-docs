...
Puede crear un mapa de configuración `rancher-config` en el espacio de nombres `cattle-system` con xref:reference/ref-configuration.adoc#_configure-product-install-options-in-rancher[Opciones de Instalación de Fleet].

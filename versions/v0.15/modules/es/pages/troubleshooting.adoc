...
[#_d-nde-buscar-las-causas-ra-z-de-los-problemas]
...
[#_obtener-el-registro-de-fleet-controller]
...
[#_recoger-el-registro-del-fleet-agent]
...
[#_recoger-registros-de-error-detallados-de-gitrepos-y-bundles]
...
[#_obtener-el-estado-detallado-de-gitrepos-y-bundles]
...
[#_verifique-un-error-de-renderizado-de-gr-fico-en-kustomize]
=== ¿Verifique un error de renderizado de gráfico en `Kustomize`?

Verifique los registros de xref:troubleshooting.adoc#_fetch-the-log-from-fleet-controller[`fleet-controller`] y los registros de xref:troubleshooting.adoc#_fetch-the-log-from-the-fleet-agent[`fleet-agent`].

[#_verifique-errores-sobre-observar-o-revisar-el-gitrepo-o-sobre-el-repositorio-helm-descargado-en-fleet-yaml]
...
[#_compruebe-el-estado-del-fleet-controller]
...
[#_active-el-registro-de-depuraci-n-para-fleet-controller-y-fleet-agent]
...
[#_a-trav-s-de-opciones-de-instalaci-n-de-fleet]
...
[#_registrar-cambios-de-recursos-a-lo-largo-del-tiempo]
...
[#_soluciones-adicionales-para-otros-problemas-de-product-name]
== *Soluciones Adicionales para Otros Problemas de {product_name}*

[#_convenciones-de-nomenclatura-para-crds]
...
[#_product-name-falla-con-un-c-digo-de-respuesta-incorrecto-403]
...
[#_repositorio-de-charts-de-helm-certificado-firmado-por-una-autoridad-desconocida]
...
[#_product-name-ampliaci-n-atascada-en-estado-modificado]
...
[#_la-sincronizaci-n-de-gitrepo-falla-sin-reintento]
...
[#_gitrepo-o-bundle-atascados-en-estado-modificado]
...
[#_el-bundle-tiene-un-horizontal-pod-autoscaler-hpa-en-estado-modificado]
...
Debes definir un parche en el `fleet.yaml` para ignorar este campo de acuerdo con xref:troubleshooting.adoc#_gitrepo-or-bundle-stuck-in-modified-state[`GitRepo` o `Bundle` atascado en estado modificado].
...
[#_qu-pasa-si-el-cl-ster-no-est-disponible-o-est-en-un-estado-waitcheckin]
...
[#_gitrepo-se-queja-con-gzip-invalid-header]
...
[#_el-agente-ya-no-est-registrado]
...
[#_migrar-el-cl-ster-local-al-espacio-de-trabajo-del-cl-ster-por-defecto-product-name]
...
[#_el-paquete-no-se-pudo-desplegar-el-recurso-ya-existe-error]

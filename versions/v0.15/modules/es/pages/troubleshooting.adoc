...
Puede crear un mapa de configuración `rancher-config` en el espacio de nombres `cattle-system` con xref:reference/ref-configuration.adoc#_configure_product_install_options_in_rancher[Opciones de Instalación de Fleet].

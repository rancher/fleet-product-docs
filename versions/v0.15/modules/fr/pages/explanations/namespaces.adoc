...
[#_workload-namespaces]
== Espaces de noms de charge de travail

[#_namespace-creation-behavior-in-bundles]
...
[#_configuring-workload-namespaces]
...
[#_allowed-target-namespace-selector]
...
[#_cluster-registration-namespace-fleet-local]
...
[#_system-namespace-cattle-fleet-system]
...
[#_system-registration-namespace-cattle-fleet-clusters-system]

...
[#_generating-comparepatches-with-fleet-bundlediff]
...
[#_generating-a-fleet-yaml-comparepatches-snippet]
...
[#_ignoring-object-modifications]
...
[#_2-deployment-gatekeeper-controller-manager]
...
[#_3-deployment-gatekeeper-audit]

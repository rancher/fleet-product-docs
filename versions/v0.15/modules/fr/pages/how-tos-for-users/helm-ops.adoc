...
[#_cr-ation-d-une-ressource-helmop]
...
[#_cas-d-utilisation-pris-en-charge]
...
[#_r-f-rence-de-chart-et-url-de-d-p-t]
...
Pour plus d'informations, référez-vous à xref:how-tos-for-users/gitrepo-add.adoc#_using-private-helm-repositories[Private Helm repo].

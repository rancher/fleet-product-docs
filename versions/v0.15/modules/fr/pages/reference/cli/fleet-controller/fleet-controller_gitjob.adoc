...
Configurer les opérations du Fleet controller gitjob
...
* xref:reference/cli/fleet-controller/fleet-controller.adoc[fleet-controller]     - Gérer le Fleet controller qui communique avec le Fleet agent

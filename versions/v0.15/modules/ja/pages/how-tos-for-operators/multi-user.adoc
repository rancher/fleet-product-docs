...
RBACに追加されるのは、xref:explanations/namespaces.adoc#_restricting-gitrepos[`GitRepoRestriction`]リソースで、これはネームスペース内のGitRepoリソースを制御するために使用できます。
...
各ユーザーのネームスペース内で、管理者としてxref:explanations/namespaces.adoc#_cross-namespace-deployments[`BundleNamespaceMapping`]を作成します。

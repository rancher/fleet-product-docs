...
| yaml
| YAMLオプション、生のYAMLを使用する場合、これらはリソースを置き換えたりパッチを当てたりするために使用される++overlays/{name}++ファイルにマッピングされる名前です。
| *<<_yamloptions,YAMLOptions>>
| false
...
YAMLOptions、未加工のYAMLを使用する場合、これらはリソースを置き換えたりパッチを当てたりするために使用される++overlays/{name}++ファイルにマッピングされる名前です。

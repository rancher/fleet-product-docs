...
`cattle-system`ネームスペースに`rancher-config`という設定マップをxref:reference/ref-configuration.adoc#_configure_product_install_options_in_rancher[Fleetインストールオプション]で作成できます。

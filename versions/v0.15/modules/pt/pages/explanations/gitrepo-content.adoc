...
Clusters endurecidos devem adicionar os CRDs do Fleet à xref:how-tos-for-users/gitrepo-add.adoc#_storing-credentials-in-git[lista de recursos criptografados em repouso], no cluster upstream, ao armazenar credenciais nos pacotes.

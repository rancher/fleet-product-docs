...
[#_como-os-reposit-rios-s-o-escaneados]
...
[#_escaneamento-alternativo-definido-explicitamente-pelo-usu-rio]
...
[#_exemplo-de-estrutura-de-diret-rios]
...
[#_defini-o-correspondente-do-gitrepo]
...
[#_excluindo-arquivos-e-diret-rios-de-pacotes]
...
Veja xref:how-tos-for-users/gitrepo-add.adoc#_using-private-helm-repositories[Usando Repositórios Helm Privados].

[#_usando-valores-do-helm]
...
A etapa de direcionamento pode tratar valores como modelos usando informações do cluster. Mais informações: xref:/reference/ref-fleet-yaml.adoc#_values-templating[templates em fleet.yaml].
...
A etapa de direcionamento pode tratar os valores como um template e preencher informações do recurso `clusters.fleet.cattle.io`. Para mais informações, consulte xref:reference/ref-fleet-yaml.adoc#_values-templating[Templating de valores do Helm].
...
[#_entendendo-helm-values-yaml-vs-fleet-valuesfiles]
...
[#_arquivos-values-do-fleet-referenciados-a-partir-do-fleet-yaml]
...
----
Veja xref:how-tos-for-users/gitrepo-targets.adoc#_customization-per-cluster[personalização por cluster].

[#_personaliza-o-de-recurso-yaml-bruto]

...
[#_namespaces-de-trabalho]
== Namespaces de Trabalho

[#_comportamento-de-cria-o-de-namespace-em-bundles]
...
[#_configurando-namespaces-de-trabalho]
...
[#_namespaces-de-destino-permitidos]
...
[#_selecionador-de-namespace-de-destino-permitido]
...
Se você estiver usando {product_name} em um estilo xref:explanations/concepts.adoc[single cluster], o namespace será sempre *fleet-local*.  Consulte a seção <<_cluster-registration-namespace-fleet-local,`fleet-local` namespaces>> para mais informações.
...
[#_namespaces-internos]
=== Namespaces Internos

[#_namespace-de-registro-de-cluster-fleet-local]
...
[#_namespace-do-sistema-cattle-fleet-system]
...
[#_namespace-de-registro-do-sistema-cattle-fleet-clusters-system]

...
Uma adição ao RBAC é o recurso xref:explanations/namespaces.adoc#_restricting-gitrepos[`GitRepoRestriction`], que pode ser usado para controlar recursos GitRepo em um namespace.
...
[#_exemplo-product-name-aut-nomo]
...
[#_espa-os-de-trabalho-isolados-no-rancher]
...
Em cada um dos namespaces do usuário, como administrador, crie um xref:explanations/namespaces.adoc#_cross-namespace-deployments[`BundleNamespaceMapping`].
...
[#_restringindo-o-acesso-aos-clusters-downstream]
...
[#_um-exemplo-de-recurso-gitrepo]

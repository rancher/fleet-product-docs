...
[#_refer-ncia-do-chart-e-url-do-reposit-rio]
...
Para mais informações, consulte xref:how-tos-for-users/gitrepo-add.adoc#_using-private-helm-repositories[Repositório privado do Helm].

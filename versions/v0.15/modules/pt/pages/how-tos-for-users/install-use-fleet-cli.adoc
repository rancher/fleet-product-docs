...
** `fleet apply -o - name ./folder` para verificar o YAML do bundle antes de criá-lo. Para mais informações, veja xref:explanations/ref-bundle-stages.adoc#_examining_the_bundle_lifecycle_with_the_cli[Examinando o Ciclo de Vida do Bundle com o CLI].
...
Para mais informações, veja xref:reference/ref-registration.adoc#_product_name_agent_is_registered_watches_for_bundledeployments[O Fleet Agent está registrado e monitora as implantações de bundle].

...
** `fleet apply -o - name ./folder` para verificar o YAML do bundle antes de criá-lo. Para mais informações, veja xref:explanations/ref-bundle-stages.adoc#_examining-the-bundle-lifecycle-with-the-cli[Examinando o Ciclo de Vida do Bundle com o CLI].
...
Para mais informações, veja xref:reference/ref-registration.adoc#_product-name-agent-is-registered-watches-for-bundledeployments[O Fleet Agent está registrado e monitora as implantações de bundle].

...
Implante um recurso bundledeployment/content em um cluster, criando um release Helm. Isso não implantará os recursos bundledeployment/content diretamente no cluster.

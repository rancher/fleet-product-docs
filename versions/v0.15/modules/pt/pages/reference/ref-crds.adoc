...
* <<_diffoptions,Opções de Diferença>>
* <<_helmoptions,Opções Helm>>
...
* <<_yamloptions,Opções YAML>>
* <<_bundlenamespacemappinglist,BundleNamespaceMappingList>>
* <<_agentstatus,AgentStatus>>
* <<_clusterdisplay,Exibição de Cluster>>
...
* <<_contentlist,Lista de Conteúdo>>
...
* <<_alphabeticalpolicy,Política Alfabética>>
...
<<_resources,Voltar para Recursos Personalizados>>
...
| <<_bundledisplay,Exibição do Pacote>>
| falso

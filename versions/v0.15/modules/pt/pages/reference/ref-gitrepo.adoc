...
O recurso GitRepo descreve repositórios git, como acessá-los e onde os pacotes estão localizados.

O conteúdo do recurso corresponde ao xref:reference/ref-crds.adoc#_gitrepospec[GitRepoSpec].
Para mais informações sobre como usar o recurso GitRepo, por exemplo, como monitorar repositórios privados, veja xref:how-tos-for-users/gitrepo-add.adoc[Criar um Recurso GitRepo].
...
* xref:how-tos-for-users/gitrepo-add.adoc#_use_different_helm_credentials_for_each_path[Criar um Recurso GitRepo].

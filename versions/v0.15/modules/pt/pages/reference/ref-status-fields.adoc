...
* `state` : Representa o estado do GitRepo (por exemplo, `GitUpdating`) ou o maior BundleState conforme a <<_state-ranking,Classificação de Estado>>. Se `Ready`, é definido como um valor vazio.

...
Você pode criar um mapa de configuração `rancher-config` no namespace `cattle-system` com xref:reference/ref-configuration.adoc#_configure-product-install-options-in-rancher[Opções de Instalação do Fleet].

...
[#_onde-procurar-as-causas-raiz-dos-problemas]
...
[#_buscar-o-log-de-fleet-controller]
...
[#_busque-logs-de-erro-detalhados-de-gitrepos-e-bundles]
...
[#_busque-status-detalhado-de-gitrepos-e-bundles]
...
[#_verifique-um-erro-de-renderiza-o-de-gr-fico-em-kustomize]
=== Verifique um erro de renderização de gráfico em `Kustomize`?

Verifique os logs de xref:troubleshooting.adoc#_fetch-the-log-from-fleet-controller[`fleet-controller`] e os logs de xref:troubleshooting.adoc#_fetch-the-log-from-the-fleet-agent[`fleet-agent`].

[#_verifique-erros-ao-monitorar-ou-verificar-o-gitrepo-ou-sobre-o-reposit-rio-helm-baixado-em-fleet-yaml]
...
[#_verifique-o-status-do-fleet-controller]
...
[#_ativar-o-registro-de-depura-o-para-fleet-controller-e-fleet-agent]
...
[#_via-op-es-de-instala-o-do-fleet]
...
[#_registrar-mudan-as-de-recursos-ao-longo-do-tempo]
...
[#_solu-es-adicionais-para-outros-problemas-de-product-name]
== *Soluções Adicionais para Outros Problemas de {product_name}*

[#_conven-es-de-nomenclatura-para-crds]
...
[#_product-name-falha-com-c-digo-de-resposta-ruim-403]
...
[#_reposit-rio-do-chart-helm-certificado-assinado-por-autoridade-desconhecida]
...
[#_product-name-implanta-o-presa-no-estado-modificado]
...
[#_a-sincroniza-o-do-gitrepo-falha-sem-nova-tentativa]
...
[#_gitrepo-ou-bundle-preso-em-estado-modificado]
...
[#_o-bundle-possui-um-horizontal-pod-autoscaler-hpa-em-estado-modificado]
...
Você deve definir um patch no `fleet.yaml` para ignorar este campo de acordo com xref:troubleshooting.adoc#_gitrepo-or-bundle-stuck-in-modified-state[`GitRepo` ou `Bundle` preso em estado modificado].
...
[#_e-se-o-cluster-estiver-indispon-vel-ou-estiver-em-um-estado-waitcheckin]
...
[#_gitrepo-reclama-com-gzip-invalid-header]
...
[#_o-agente-n-o-est-mais-registrado]
...
[#_migrar-o-cluster-local-para-o-workspace-do-cluster-padr-o-product-name]
...
[#_falha-ao-implantar-o-bundle-recurso-j-existe-erro]

...
RBAC 的一个附加功能是 xref:explanations/namespaces.adoc#_restricting-gitrepos[`GitRepoRestriction`] 资源，可以用于控制名称空间中的 GitRepo 资源。
...
在每个用户的名称空间中，作为管理员创建一个 xref:explanations/namespaces.adoc#_cross-namespace-deployments[`BundleNamespaceMapping`]。

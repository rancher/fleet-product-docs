...
** xref:explanations/target-customization.adoc[Target Customization]
** xref:explanations/multi-tenancy.adoc[Multi-Tenancy]
...
** xref:how-tos-for-operators/tenant-setup.adoc[Tenant Setup]
** xref:how-tos-for-operators/resource-limits.adoc[Configure Resource Limits]
* How-tos for Users
...
** xref:how-tos-for-users/templating.adoc[Templating]
...
*** xref:reference/ref-policy.adoc[Policy Resource]
...
* Changelog
** xref:changelogs/v0.16.0.adoc[v0.16.0]
** xref:changelogs/other.adoc[Other Releases]
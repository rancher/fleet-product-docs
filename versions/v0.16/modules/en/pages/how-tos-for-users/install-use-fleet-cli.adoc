...
For more information, see xref:reference/ref-registration.adoc#_productname_agent_is_registered_watches_for_bundledeployments[Fleet Agent is Registered, Watches for BundleDeployments].

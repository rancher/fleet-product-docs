...
image::/img/ModifiedGitRepo.png[]

Associated Bundle
image:/img/ModifiedBundle.png[]

Fleet bundles support the ability to specify a custom http://jsonpatch.com/[jsonPointer patch].
...
image::/img/WebhookConfigurationSpec.png[]

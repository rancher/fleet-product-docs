...
For more on the naming conventions of CRDs, click xref:./troubleshooting.adoc#naming-conventions-for-crds[here].
====
 ...
 ** For an example of how to deploy Kubernetes manifests across clusters using Fleet customization, click xref:./gitrepo-targets.adoc#customization-per-cluster[here].

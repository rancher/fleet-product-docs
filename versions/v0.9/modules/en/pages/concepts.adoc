 ...
 ** For an example of how to deploy Kubernetes manifests across clusters using Fleet customization, click xref:./gitrepo-targets.adoc#_customization_per_cluster[here].

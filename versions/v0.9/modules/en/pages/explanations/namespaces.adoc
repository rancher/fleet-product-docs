...
If you are using {product_name} in a xref:explanations/concepts.adoc[single cluster] style, the namespace will always be *fleet-local*.  Refer to the <<_fleet-local-local-workspace-cluster-registration-namespace,`fleet-local` namespaces section>> for more information.
...
[#_fleet-local-local-workspace-cluster-registration-namespace]
...
[#_cattle-fleet-system-system-namespace]
...
[#_cattle-fleet-clusters-system-system-registration-namespace]

...
Create a secret containing username and password. You can replace the password with a personal access token if necessary. Also see link:./troubleshooting#http-secrets-in-github[HTTP secrets in Github].

...
If you are using {product_name} in a xref:explanations/concepts.adoc[single cluster] style, the namespace will always be *fleet-local*. Check https://fleet.rancher.io/namespaces/#fleet-local[here] for more on the `fleet-local` namespace.
